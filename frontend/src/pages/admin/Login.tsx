    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
        <div className="text-center">
          <h1 className="font-headline text-2xl font-black text-secondary">Admin</h1>
          <p className="text-sm text-gray-500 mt-1">Inicia sesión para administrar el evento</p>
        </div>
